                                ...
                                children: [
                                  Container(
                                    ...
                                    child: item.product.imageUrl.startsWith('data:image') 
                                        ? Image.memory(base64Decode(item.product.imageUrl.split(',').last), fit: BoxFit.cover, errorBuilder: (_,__,___) => const Icon(Icons.error, size: 16))
                                        : Image.network(item.product.imageUrl, fit: BoxFit.cover, errorBuilder: (_,__,___) => const Icon(Icons.error, size: 16)),
                                  ),
